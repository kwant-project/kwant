...
Kwant 1.0 was released on 9 September 2013.  Please consult the
`full list of changes in Kwant <http://git.kwant-project.org/kwant/log/>`_ for all the changes up to the most recent bugfix release.
