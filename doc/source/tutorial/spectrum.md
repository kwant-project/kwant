...
\"Usual way\" means defining a translational symmetry vector, as well as
...
Although Kwant is (currently) mainly aimed towards transport problems,
...
The eigenvectors are obtained very similarly, and can be plotted
